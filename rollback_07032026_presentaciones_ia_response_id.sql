-- ROLLBACK: Renombrar columna ia_response_id a openai_response_id
-- Fecha: 2026-03-07
...
SET @sql_rename := IF(
  @tabla_existe > 0 AND @columna_ia_existe > 0 AND @columna_openai_existe = 0,
  'ALTER TABLE `presentaciones` CHANGE COLUMN `ia_response_id` `openai_response_id` varchar(120) NOT NULL',
  'SELECT 1'
);
